    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                siakad: {
                    dark: "var(--siakad-dark, #1B3C53)",
                    primary: "var(--siakad-primary, #234C6A)",
                    secondary: "var(--siakad-secondary, #456882)",
                    light: "var(--siakad-light, #E3E3E3)",
                    50: "#f0f7fb",
                    100: "#dceef6",
                    200: "#b9dded",
                    300: "#86c5e0",
                    400: "#4da5cc",
                    500: "var(--siakad-primary, #234C6A)",
                    600: "var(--siakad-dark, #1B3C53)",
                    700: "#163247",
                    800: "#122839",
                    900: "#0d1e2b",
                },
