            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-xl w-full max-w-md animate-fade-in overflow-hidden shadow-xl">
                ...
                <form action="{{ route('admin.dosen.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-6 space-y-4">
                        <p class="text-sm text-siakad-secondary dark:text-gray-400">Pilih berkas Excel (.xlsx / .xls / .csv) dengan format kolom: <strong>NIDN, Nama Dosen, Email, Password, Prodi</strong>.</p>
                        <div class="p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg flex items-center justify-between">
                            ...
                            <a href="{{ route('admin.dosen.template') }}" class="text-xs text-blue-600 hover:text-blue-800 dark:text-blue-400 underline font-semibold flex items-center gap-1">
