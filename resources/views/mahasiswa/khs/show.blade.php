            ...
            <div class="card-saas overflow-hidden">
                <div class="px-6 py-4 border-b border-siakad-light flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ route('mahasiswa.khs.print', $tahunAkademik) }}" target="_blank" class="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-600/10 text-emerald-700 rounded-lg text-sm font-medium hover:bg-emerald-600/20 transition">
