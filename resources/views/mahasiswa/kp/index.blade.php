    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <div class="lg:col-span-2 card-saas p-6">
            <div class="flex items-start justify-between mb-4">
                ...
                @if(in_array($kp->status, ['disetujui', 'berlangsung', 'penyusunan_laporan', 'selesai']))
                <a href="{{ route('mahasiswa.kp.surat') }}" target="_blank" class="px-4 py-2 bg-[#234C6A] hover:bg-[#1a3850] text-white rounded-lg text-sm font-medium inline-flex items-center gap-2 shadow-sm shadow-[#234C6A]/20 transition-all">
