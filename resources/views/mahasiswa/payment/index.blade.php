                            ...
                            <tbody class="divide-y divide-siakad-light dark:divide-gray-700">
                                @forelse($pembayaran as $p)
                                    <tr class="dark:text-gray-300">
                                        ...
                                        <td class="px-6 py-4">
                                            @if($p->bukti_transfer)
                                                <a href="{{ asset('storage/' . $p->bukti_transfer) }}" target="_blank" class="text-siakad-primary dark:text-blue-400 hover:underline text-xs flex items-center gap-1 font-semibold">
