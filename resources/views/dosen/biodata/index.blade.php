                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $dosen->tempat_lahir) }}" placeholder="Contoh: Jakarta" class="input-saas w-full px-4 py-2.5 text-sm" style="background-color: var(--bg-card);">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="provinsi" value="{{ old('provinsi', $dosen->provinsi) }}" placeholder="Contoh: Jawa Barat" class="input-saas w-full px-4 py-2.5 text-sm" style="background-color: var(--bg-card);">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-siakad-dark mb-2">Kecamatan</label>
                                <input type="text" name="kecamatan" value="{{ old('kecamatan', $dosen->kecamatan) }}" placeholder="Contoh: Sumur Bandung" class="input-saas w-full px-4 py-2.5 text-sm" style="background-color: var(--bg-card);">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="kelurahan" value="{{ old('kelurahan', $dosen->kelurahan) }}" placeholder="Contoh: Babakan Ciamis" class="input-saas w-full px-4 py-2.5 text-sm" style="background-color: var(--bg-card);">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-siakad-dark mb-2">Desa</label>
                                <input type="text" name="desa" value="{{ old('desa', $dosen->desa) }}" placeholder="Contoh: Babakan" class="input-saas w-full px-4 py-2.5 text-sm" style="background-color: var(--bg-card);">
                            </div>
                        </div>
